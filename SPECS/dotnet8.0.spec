...
%changelog
* Wed Apr 08 2026 Omair Majid <omajid@redhat.com> - 8.0.126-1
- Update to .NET SDK 8.0.126 and Runtime 8.0.26
- Resolves: RHEL-163416

* Tue Mar 03 2026 Dominik Rehák <drehak@redhat.com> - 8.0.125-1
- Update to .NET SDK 8.0.125 and Runtime 8.0.25
- Resolves: RHEL-152936

* Mon Feb 02 2026 Omair Majid <omajid@redhat.com> - 8.0.124-1
- Update to .NET SDK 8.0.124 and Runtime 8.0.24
- Resolves: RHEL-144968

* Thu Jan 08 2026 Omair Majid <omajid@redhat.com> - 8.0.123-1
- Update to .NET SDK 8.0.123 and Runtime 8.0.23
- Resolves: RHEL-138654

* Mon Nov 03 2025 Omair Majid <omajid@redhat.com> - 8.0.122-1
- Update to .NET SDK 8.0.122 and Runtime 8.0.22
- Resolves: RHEL-125740
